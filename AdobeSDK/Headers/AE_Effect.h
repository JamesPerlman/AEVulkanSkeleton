...
#define PF_AE_PLUG_IN_VERSION				PF_AE182_PLUG_IN_VERSION	// manually set for mid-cycle SDK drop
#define PF_AE_PLUG_IN_SUBVERS				PF_AE182_PLUG_IN_SUBVERS	// manually set for mid-cycle SDK drop
